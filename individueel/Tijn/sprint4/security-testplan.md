...
**Status:** Concept. Wacht op validatie door Marc voordat de actieve tests starten.
...
## 12. Validatievragen voor Marc

1. Is deze chatbot-gerichte scope passend, of mis ik iets?
2. Zijn OWASP LLM Top 10 plus STRIDE plus de risicomatrix de juiste standaardmethodes hiervoor?
3. Ben je akkoord met de rules of engagement, vooral rond de kosten van test #4?
4. **Belangrijk voor mijn doel:** telt deze chatbot-gerichte scope voor jou nog als Analyse en Advies op de **Infrastructure**-laag, of leunt het te veel richting Software? Wil je dat ik een dun plakje infra-analyse erin houd (bijvoorbeeld de externe Anthropic-afhankelijkheid en de dataflow tussen de componenten) om de Infra-haak sterk te houden?
5. Zou je een bevinding toevoegen of juist buiten scope houden?

## 13. Competentieverantwoording (HBO-i)

Dit werk levert naar verwachting bewijs voor:

- **Analyse (Infrastructure) - Niveau 1:** het analyseren van de security threats volgens een standaardmethode, op basis van de kwaliteitseis security.
- **Advies (Infrastructure) - Niveau 1:** adviseren over een veilige inrichting van de chatbot en zijn omgeving.
- **Mogelijk PS-2 (Professional standard):** professioneel werken met een vooraf afgestemde scope, stakeholder-betrokkenheid (Marc) en ethisch, geautoriseerd testen.

**Eerlijke kanttekening:** door op de chatbot te focussen leunt het werk deels richting de Software-laag (AppSec). Mijn doel is juist Infrastructure niveau 1. Om de Infra-haak te houden frame ik de dreigingen rond de ICT-systemen die de chatbot draaien: de externe Anthropic-afhankelijkheid (beschikbaarheid en kosten) en de dataflow tussen het model, de vector-DB en de app. Of dit zo voldoende op Infrastructure mapt, stem ik af met Marc (zie vraag 4).

De definitieve verantwoordingstekst schrijf ik na de uitvoering, zodat die klopt met wat ik echt heb gevonden en gedaan.
