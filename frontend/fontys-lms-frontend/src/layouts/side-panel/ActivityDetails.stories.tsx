...
const WORKSHOP_ACTIVITY: ActivityItem =
  initialActivities.find((activity) => activity.type === 'workshop') ?? {
    ...DEFAULT_ACTIVITY,
    id: 'workshop-story',
    type: 'workshop',
...
const DONE_ACTIVITY: ActivityItem =
  initialActivities.find((activity) => activity.status === 'afgerond') ?? {
    ...DEFAULT_ACTIVITY,
    id: 'done-story',
    status: 'afgerond',
  }
